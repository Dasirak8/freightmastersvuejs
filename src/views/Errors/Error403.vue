<template>
  <link href="https://fonts.googleapis.com/css?family=Montserrat:100,200,300,400,500,600,700,800,900|Nunito:200,300,400,600,700,800,900&display=swap" rel="stylesheet">
  <div class="error403">
    <div class="page-wrap">
      <div class="page-not-found">
        ...
        <h4 class="text-sm text-sm-btm">You don’t have access to this area of application. Your role does not allow access to this server. You can go back to <a href="http://freightmasters.ge">main page</a></h4>
      </div>
    </div>
  </div>
</template>
